...
"""
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time timestamp NOT NULL, user_id integer NOT NULL, level VARCHAR, song_id VARCHAR, artist_id VARCHAR, session_id VARCHAR, location VARCHAR, user_agent VARCHAR);""")
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs (song_id VARCHAR PRIMARY KEY, title VARCHAR NOT NULL, artist_id VARCHAR, year INT, duration FLOAT8 NOT NULL);
""")
...
# FIND SONGS
"""
- Query for selecting song_id and artist_id
"""
...
# QUERY LISTS
"""
- array of create_table queries and drop_table queries
"""
